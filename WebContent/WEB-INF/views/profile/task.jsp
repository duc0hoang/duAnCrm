                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="white-box">
                                    <div class="col-in row">
                                        <div class="col-xs-12">
                                            <h3 class="counter text-right m-t-15 text-danger"><%= chuaBatDau*100/taskDtoList.size() %>%</h3>
                                        </div>
                                        <div class="col-xs-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="white-box">
                                    <div class="col-in row">
                                        <div class="col-xs-12">
                                            <h3 class="counter text-right m-t-15 text-megna"><%= dangThucHien*100/taskDtoList.size() %>%</h3>
                                        </div>
                                        <div class="col-xs-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="white-box">
                                    <div class="col-in row">
                                        <div class="col-xs-12">
                                            <h3 class="counter text-right m-t-15 text-primary"><%= daHoanThanh*100/taskDtoList.size() %>%</h3>
                                        </div>
                                        <div class="col-xs-12">
                                            <i class="linea-icon linea-basic" data-icon="&#xe00b;"></i>
                                    ...
                                    <tbody>
                                    	<%for(TaskDto taskDto : taskDtoList){ %>
					                        <tr>
					                        	...
					                        	<td>
					                                <a href="<%= contextPath %>/profile/task/edit?id=<%= taskDto.getId() %>" class="btn btn-sm btn-primary">Cập nhật</a>
					                            </td>
					                        </tr>
					                   	<%} %>
                                    </tbody>
