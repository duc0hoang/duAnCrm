            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="<%= contextPath + UrlConstant.URL_ROLE_ADD %>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="${role.description }" class="form-control form-control-line" name="description"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
