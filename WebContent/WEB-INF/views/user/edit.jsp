            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="<%= contextPath%>/user/edit">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
		                        		...
		                        		<option value="<%= role.getId()%>" <%= role.getId() == user.getRole_id() ? "Selected" : "" %>><%= role.getDescription() %></option>
		                        		<%} %>
                                        </select>
                                    </div>
                                </div>
